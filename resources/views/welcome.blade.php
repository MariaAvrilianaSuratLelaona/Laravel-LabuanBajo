...
<body>
    <div class="container">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('transaction') }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="labelmodal" for="detail-price">Price :</label>
                                                <input class="inputdata" type="text" name="detail-price"
                                                    class="form-control" id="detail-price"
        ...
        <footer>
            <h4>&copy; Labuan Bajo: Menikmati Surga Tersembunyi Di Nusa Tenggara Timur </h4>
        </footer>
    </div>
    <script>
